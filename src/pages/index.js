...
export default class TemplateWrapper extends React.Component{
	...
	{/*
	<div id="crt-sidebar" >
		<button onClick={this.toggleSidenav.bind(this)} id="crt-sidebar-close" className="btn btn-icon btn-light btn-shade"><span className="crt-icon crt-icon-close"></span></button>
	<MobileMenu />
    </div>
    */}
    <FooterWrapper />
